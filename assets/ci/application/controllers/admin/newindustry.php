...
class Newindustry extends CI_controller{
	...
	public function index(){
           ...
           if(($this->session->userdata('user_id')!=""))
                                    ...
                                    $this->load->view('admin/_layout_newindustry');
	  ...
	  if ($this->form_validation->run() == FALSE)
                            {
                             ...
                             else
                             {
                                 ...
                                 $result = $this->model_press->insert_industry();
	                                 if($result)
	                                 {
	  ...
	  if ($this->form_validation->run() == FALSE)
                            {
                             ...
                             {
                             	 $this->load->model('admin/model_press');
                                 $result = $this->model_press->edit_industry();
	                                 if($result)
	                                 {
	                                  $this->load->view('admin/db_updated');
	                                  }
