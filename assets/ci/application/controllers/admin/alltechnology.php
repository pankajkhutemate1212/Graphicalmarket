...
defined('BASEPATH') OR exit('No direct script access allowed');
  ...
  class alltechnology extends CI_Controller 

  {
    ...
    {   
      ...
      $data['press'] = $this->press_model->get_technology_report();
    ...
    //  $data['content'] = 'elements/home';
     ...
     // $this->load->view('admin/_layout_allpress', $data);
       ...
       if(($this->session->userdata('user_id')!=""))
            ...
            $this->load->view('admin/_layout_alltechnology', $data);
...

	{
	  ...
	  $data['press'] = $this->press_model->get_technology_detail($url);
