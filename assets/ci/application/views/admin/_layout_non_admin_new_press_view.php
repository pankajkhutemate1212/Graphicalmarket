...
success: function(data)  
{
	...
	if(data=='Error'){
		...
		$("#imageBox").html('<img style="height:100px" src="<?php echo 'http://aeresearch.net/img/'; ?>'+ data +'" />');
		$("#imgurl").val(data);
...
<?php echo form_open('admin/newpress/insert_press_for_report_section'); ?>
<style>
...
$("form").attr("action", "//aeresearch.net/assets/ci/admin/schedule/schedule_press");
		}
		if($('input.rbt_schedule:radio:checked').val()=='No')
		{
			$('p.scheduler_para').removeClass('schedule-yes');
$("form").attr("action", "//aeresearch.net/assets/ci/admin/newpress/insert_press_for_report_section");
...
$timestampdsf = date("m/d/Y");?>
	...
	<input name="news_type" id="type"  type="radio" value="science-and-environment" required=""><span class="lbl">	
Science and Environment</span>
	<input name="news_type" id="type" type="radio" value="technology" required=""><span class="lbl">Tech</span>
	<input name="news_type" id="type" type="radio" value="headlines" required=""><span class="lbl">Headlines</span>
	<input name="news_type" id="type" type="radio" value="business" required=""><span class="lbl">Business</span>
	<input name="news_type" id="type" type="radio" value="research" required=""><span class="lbl">Research</span>
	</td>
</tr>
...
<tr>
        <td style="width:15%">Related Keyword<span class="madnatory">*</span></span></td>
	<td><input type="text" name="relatedkeyword" id="relatedkeyword" style="width: 99%;" placeholder="Enter Related Keywords" required="">  </td>
</tr> 
...
<!--<tr>
	...
	<?php if($this->session->userdata('email')=="ronak.b@algosonline.com"){?>
	<input name="author" id="author"  type="radio" value="Ronak Bora" required="" checked="checked"><span class="lbl"> Ronak Bora</span>
	<?php } elseif($this->session->userdata('email')=="rahul.s@algosonline.com") { ?>
	<input name="author" id="author"  type="radio" value="Rahul Sankrityayan" required="" checked="checked"><span class="lbl"> Rahul Sankrityayan</span>
	<?php } elseif($this->session->userdata('email')=="rahul.v@algosonline.com") { ?>
	<input name="author" id="author"  type="radio" value="Rahul Varpe" required="" checked="checked"><span class="lbl"> Rahul Varpe</span>
	<?php } elseif($this->session->userdata('email')=="partha.r@algosonline.com") { ?>
		<input name="author" id="author"  type="radio" value="Partha Ray" required="" checked="checked"><span class="lbl"> Partha Ray</span>
	<?php } else { ?>
    ...
    <input name="author" id="author" type="radio" value="Pankaj Singh" required=""><span class="lbl"> Pankaj</span>
    <?php } ?>
	</td>
</tr> -->
        <tr>
