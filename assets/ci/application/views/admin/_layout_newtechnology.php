...
<hr>
<div class="container">
<h3> Add Single Technology</h3>
<div>
<?php echo validation_errors(); ?>
<?php echo form_open('admin/newtechnology/insert_technology'); ?>
<style>
...
$("form").attr("action", "//algosonline.com/assets/ci/admin/schedule/schedule_technology");
		}
		if($('input.rbt_schedule:radio:checked').val()=='No')
		{
			$('p.scheduler_para').removeClass('schedule-yes');
$("form").attr("action", "//algosonline.com/assets/ci/admin/newtechnology/insert_technology");
