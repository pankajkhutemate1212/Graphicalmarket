...
<hr>
<div class="container">
<h3> Add Single Business Update</h3>
<div>
<?php echo validation_errors(); ?>
<?php echo form_open('admin/newbusiness/insert_business'); ?>
<style>
...
$("form").attr("action", "//algosonline.com/assets/ci/admin/schedule/schedule_business");
		}
		if($('input.rbt_schedule:radio:checked').val()=='No')
		{
			$('p.scheduler_para').removeClass('schedule-yes');
$("form").attr("action", "//algosonline.com/assets/ci/admin/newbusiness/insert_business");
