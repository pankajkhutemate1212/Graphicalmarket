...
<button id="btnSaveComments">Upload Image</button>
                ...
                $("#btnSaveComments").click((function(e) {
				 ...
				 //alert(newst);
				$.ajax({
				url: "<?php echo base_url('admin/upload/do_upload_of_reports_image') ?>", // Url to which the request is send
type: "POST",      
cache: false,
contentType: false,
processData: false,
...
success: function(data)  
{
	...
	if(data=='Error'){
		...
		$("#imageBox").html('<img style="height:100px" src="<?php echo 'http://news.marketsizeforecasters.com/img/'; ?>'+ data +'" />');
		$("#imgurl").val(data);
...
$timestampdsf = date("m/d/Y");?>
    ...
    <tr>
    <td style="padding-bottom: 15px;">Select Type</td><td colspan=3  style="padding-bottom: 15px;"> <input name="news_type" id="type"  type="radio" value="health" required=""><span class="lbl">Health</span>
	<input name="news_type" id="type" type="radio" value="retail" required=""><span class="lbl">Retail</span>
	<input name="news_type" id="type" type="radio" value="world" required=""><span class="lbl">World</span>
	<input name="news_type" id="type" type="radio" value="reports" required=""><span class="lbl">Reports</span>
	</td>
</tr>
