...
<?php if (file_exists($filename)) {?>
	...
	<div class="col-lg-8 col-md-8 col-sm-8">
		<div class="entry-header">
							<span class="meta-category"><a href="https://www.theresearchprocess.com/category/general-news/" class="herald-cat-1">General News</a></span>
			
			<h2 class="entry-title h3"><a href="<?php echo base_url();echo $row->url;echo '/'; ?>" title="<?php echo substr($row->name,0); ?>"><?php echo $row->name; ?></a></h2>
