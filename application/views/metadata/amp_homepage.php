...
<header class="container">
  <div id="headerwrap">
      <div id="header">
                 ...
                 <amp-img src="<?php echo base_url('assets/images/theresearchprocess-logo.png');?>" width="130" height="74" alt= "<?php echo $site_name;?>" class="amp-logo"></amp-img>
...
<main>
              ...
              echo " ";
                ...
                ?>
														...
														<li class="has_related_thumbnail">
                                                            <a href="<?php echo base_url('');?><?php echo $row->url;?>" rel="bookmark" title="United orders 50 new Airbus jets to replace ageing Boeing fleet">
									            
																								            	<amp-img src="<?php echo base_url($filename);?>" width="150" height="150" layout="responsive"></amp-img>
															                                                              </a>
								                <div class="related_link">
								                    <a href="<?php echo base_url('');?><?php echo $row->url;echo '/amp';?>/"><?php echo str_replace("&","&amp;",$row->name); ?></a>
  ...
  <footer class="container">
      <div id="footer">
        ...
        <p>
            <a href="#header">
              Top </a>  |   <a class="view-non-amp" href="<?php echo base_url();?>" rel="nofollow">View Non-AMP Version </a>         
