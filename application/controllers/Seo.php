...
Class Seo extends CI_Controller {
    ...
    
    {
    	...
    	ini_set('memory_limit', '15545412M');


      
            $data['press'] = $this->Press_model->get_rep_detail_seo();
                  $data['all_cat_pages'] = $this->Reportmodel->all_category();


        header("Content-Type: text/xml;charset=iso-8859-1");
 
      $this->load->view("metadata/sitemap",$data);
   ...
   public function newssitemap()
    
    {
    	...
    	ini_set('memory_limit', '1515552M');
	
	 $data['health'] = $this->sitemap_model->get_news_sitmap_news();

	 header("Content-Type: text/xml;charset=iso-8859-1");
     $this->load->view("metadata/newssitemap",$data);
